...
public class Constants {
    ...
    public static final String DEFENSIVE_REBOUND_BUTTON_LABEL = "Defensive Rebound";
    public static final String BLOCK__BUTTON_LABEL = "Block";
    public static final String CHARGE_TAKEN_BUTTON_LABEL = "Charge Taken";
    public static final String PERSONAL_FOUL_BUTTON_LABEL = "Personal Foul";
